...
1. **Install the extension in your Chromium browser**:
   ...
   - **Manual build**: [download `agentlimb-chrome-v0.2.1-b5.zip`](https://github.com/hooosberg/AgentLimb/releases/download/v0.2.1/agentlimb-chrome-v0.2.1-b5.zip), extract it, then load the extracted folder from your browser's extensions page with Developer Mode enabled.
