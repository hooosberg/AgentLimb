...
- `agentlimb-chrome-v0.2.1.zip`
- `SHA256SUMS.txt`

The Chrome Web Store upload remains a manual step. The extension is the only user-facing package; its onboarding prompt bootstraps the local runtime from the fixed source tag after the agent obtains explicit user approval.
