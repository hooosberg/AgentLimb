...
1. **Установите** — [скачайте zip](https://github.com/hooosberg/AgentLimb/releases/latest), распакуйте, откройте `chrome://extensions`, включите **Режим разработчика**, нажмите **Загрузить распакованное** и выберите папку
